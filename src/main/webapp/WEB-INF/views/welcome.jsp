...
<body>
<div class="container">
    <h2 id="article_header" class="text-warning" align="center">Event Manager</h2>
    <div> </div>

    <!-- Div to add a new user to the mongo database -->
    <div id="add_new_user">
        <c:url var="addUrl" value="/user/add" /><a id="add" href="${addUrl}" class="btn btn-success">Add Event</a>
    </div>
    <div> </div>
    ...
    <table id="users_table" class="table">
        <thead>
        <tr align="center">
            <th>Id</th> <th>Name</th> <th>Language</th> <th>City</th> <th>Description</th> <th>Event_type</th>
        </tr>
        </thead>
        <tbody>
        <c:forEach items="${users}" var="user">
            <tr align="center">
                ...
                <td><c:out value="${user.event_type}"/></td>
